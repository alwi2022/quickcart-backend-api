...
"[project]/apps/backend/app/api/admin/_guard.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getUserFromCookie() {
    ...
    if (!token) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UnauthorizedError"]('Unauthorized');
    const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$jwt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token); // kalau verify async, jadikan: await verifyToken(token)
    return payload; // { sub, roles, iat, exp }
}
async function requireUser() {
    const u = await getUserFromCookie(); // ✅ await
    if (!u?.sub) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UnauthorizedError"]('Unauthorized');
    return u;
}
async function requireAdmin() {
    const u = await requireUser(); // ✅ await
    const roles = Array.isArray(u?.roles) ? u.roles : [];
    if (!roles.includes('admin')) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ForbiddenError"]('Forbidden');
    return u;
}
}}),
"[project]/apps/backend/app/db/models/Product.js [app-route] (ecmascript) <export default as Product>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_esm__({
    "Product": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Product.js [app-route] (ecmascript)");
}}),
"[project]/apps/backend/app/db/models/Brand.js [app-route] (ecmascript) <export default as Brand>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_esm__({
    "Brand": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Brand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Brand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Brand.js [app-route] (ecmascript)");
}}),
"[project]/apps/backend/app/db/models/Category.js [app-route] (ecmascript) <export default as Category>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_esm__({
    "Category": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Category.js [app-route] (ecmascript)");
}}),
"[project]/apps/backend/app/db/models/Inventory.js [app-route] (ecmascript) <export default as Inventory>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_esm__({
    "Inventory": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Inventory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Inventory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Inventory.js [app-route] (ecmascript)");
}}),
"[project]/apps/backend/app/api/admin/products/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/utils/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$api$2f$admin$2f$_guard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/api/admin/_guard.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Product.js [app-route] (ecmascript) <export default as Product>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Brand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Brand$3e$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Brand.js [app-route] (ecmascript) <export default as Brand>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Category$3e$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Category.js [app-route] (ecmascript) <export default as Category>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Inventory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Inventory$3e$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Inventory.js [app-route] (ecmascript) <export default as Inventory>");
...
async function GET(request) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$api$2f$admin$2f$_guard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
        ...
        const [items, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__["Product"].find(filter).sort({
                createdAt: -1
            }).skip(skip).limit(limit).select('title slug media brandId categoryIds status variants createdAt').lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__["Product"].countDocuments(filter)
        ]);
        // optional enrich brand/category names (ringan)
        const brandIds = [
            ...new Set(items.map((i)=>String(i.brandId)).filter(Boolean))
        ];
        const catIds = [
            ...new Set(items.flatMap((i)=>i.categoryIds || []).map(String))
        ];
        const [brands, categories] = await Promise.all([
            brandIds.length ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Brand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Brand$3e$__["Brand"].find({
                _id: {
                    $in: brandIds
                }
            }).select('name').lean() : [],
            catIds.length ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Category$3e$__["Category"].find({
                _id: {
                    $in: catIds
                }
            }).select('name').lean() : []
        ]);
        const bmap = new Map(brands.map((b)=>[
                String(b._id),
                b.name
            ]));
        const cmap = new Map(categories.map((c)=>[
                String(c._id),
                c.name
            ]));
        const mapped = items.map((p)=>({
                ...
                price: p.variants?.[0]?.price?.sale ?? p.variants?.[0]?.price?.list ?? null,
...
async function POST(request) {
    try {
        ...
        if (!body?.title) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('title wajib');
        if (!Array.isArray(body?.categoryIds) || body.categoryIds.length === 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('categoryIds minimal 1');
        if (!body?.brandId) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('brandId wajib');
        if (!Array.isArray(body?.variants) || body.variants.length === 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('variants minimal 1');
        for (const v of body.variants){
            if (!v?.sku) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('variant.sku wajib');
            if (!v?.price?.list && v?.price?.list !== 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('variant.price.list wajib');
        }
        // Optional: deteksi duplikat SKU varian dalam payload
        const dupe = new Set();
        for (const v of body.variants){
            const s = v.sku.trim();
            if (dupe.has(s)) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"](`SKU duplikat di payload: ${s}`);
            dupe.add(s);
        }
        const payload = {
            ...
            media: Array.isArray(body.media) ? body.media.map((m)=>({
                    url: m.url,
                    alt: m.alt || ''
                })) : [],
        ...
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__["Product"].create(payload);
        // Optional: initial inventory mapping by sku
        if (Array.isArray(body.inventory) && body.inventory.length) {
            const sk2id = new Map(doc.variants.map((v)=>[
                    v.sku,
                    v._id
                ]));
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Inventory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Inventory$3e$__["Inventory"].insertMany(body.inventory.filter((iv)=>iv?.sku).map((iv)=>({
                    product_id: doc._id,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f5c4a3._.js.map