...
"[project]/apps/backend/app/api/admin/users/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [items, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].find(filter).sort({
                createdAt: -1
            }).skip(skip).limit(limit).select('name email phone roles status createdAt').lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].countDocuments(filter)
        ]);
...
async function POST(request) {
    try {
        ...
        if (!body?.email || !body?.name) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('name & email wajib');
        const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].findOne({
            email: body.email
        }).lean();
        if (exists) throw new __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Email sudah terdaftar');
        const password_hash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$bcrypt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(body.password);
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].create({
            email: body.email,
            name: body.name,
            phone: body.phone || null,
            roles: Array.isArray(body.roles) && body.roles.length ? body.roles : [
                'customer'
            ],
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9a1ad7._.js.map