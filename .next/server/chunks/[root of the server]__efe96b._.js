...
"[project]/apps/backend/app/db/models/Order.js [app-route] (ecmascript) <export default as Order>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, t: __turbopack_require_real__ } = __turbopack_context__;
{
__turbopack_esm__({
    "Order": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Order.js [app-route] (ecmascript)");
}}),
...
"[project]/apps/backend/app/api/admin/stats/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Order$3e$__ = __turbopack_import__("[project]/apps/backend/app/db/models/Order.js [app-route] (ecmascript) <export default as Order>");
...
async function GET() {
    try {
        // ✅ 1) Auth dulu (await!)
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$api$2f$admin$2f$_guard$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
        ...
        const [ordersCount, ordersToday, gmvAgg, gmvTodayAgg, productsCount, usersCount, latestOrders, lowStockAgg] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Order$3e$__["Order"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Order$3e$__["Order"].countDocuments({
                createdAt: {
                    $gte: todayStart
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Order$3e$__["Order"].aggregate([
                {
                    $group: {
                        _id: null,
                        total: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__["Product"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"].countDocuments(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Order$3e$__["Order"].find({}).sort({
                createdAt: -1
            }).limit(6).select('orderNo status pricing.grandTotal createdAt').lean(),
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Inventory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Inventory$3e$__["Inventory"].aggregate([
        ...
        if (lowStockAgg.length) {
            ...
            if (ids.length) {
                const ps = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__Product$3e$__["Product"].find({
                    _id: {
                        $in: ids
                    }
                }).select('name').lean();
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$backend$2f$app$2f$db$2f$utils$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["json"])({
            ...
            gmv: {
                total: gmvAgg?.[0]?.total ?? 0,
                today: gmvTodayAgg?.[0]?.total ?? 0
            },
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__efe96b._.js.map